...
$string['contactselectedschool'] = 'Kontaktujte, prosím, Vámi vybranou školu o záměru konat na ní praxi';
$string['create_new_by_copy'] = 'Kopírováním vytvořit novou';
$string['creating_schedule'] = 'Vytvoření rozvrhu';
$string['dateofpraxe'] = 'Doba praxe';
$string['detail'] = 'Detail';
$string['done'] = 'Splněno';
$string['editschool'] = 'Upravit školu';
$string['email'] = 'E-mail';
$string['error_timeschedule'] = 'Začátek hodiny musí začínat dříve dříve než konec hodiny.<br>Rozvrh hodiny je možné přidat nejpozději 4 hodiny před začátkem hodiny.';
$string['error_schoolroom'] = 'Vyplňte číslo učebny.';
...
$string['lessondetail'] = 'Podrobnosti hodiny';
$string['lesson_end'] = 'Konec vyučování';
$string['lesson_number'] = 'Vyučovací hodina';
$string['lesson_start'] = 'Začátek vyučování';
$string['lesson_theme'] = 'Téma hodiny';
$string['location_added'] = 'Nabídka byla vytvořena';
...
$string['my_praxe'] = 'Má praxe';
$string['my_praxes'] = 'Mé praxe';
$string['my_praxe_info'] = 'Detaily praxe';
$string['my_schedule'] = 'Můj rozvrh';
$string['my_schools'] = 'Mé školy';
$string['my_selected_location'] = 'Má škola';
$string['no_existing_isced'] = 'Neznámý stupeň ISCED';
$string['no_existing_term'] = 'Neznámé označení semestru';
$string['no_praxe_records'] = 'Nejsou dostupné žádné praxe';
$string['no_schedule_items'] = 'Rozvrh neobsahuje žádné položky';
$string['no_teachers_available'] = 'Neexistují žádní uživatelé s právem být přiřazen ke škole.';
$string['no_teachers_for_this_school'] = 'Pro danou školu neexistují žádní učitelé.';
...
$string['praxe'] = 'Praxe';
$string['praxe_completed'] = 'Praxe kompletní';
$string['praxe_end'] = 'Konec praxe';
$string['praxe_start'] = 'Začátek praxe';
$string['praxe:addnoticetostudentschedule'] = 'Přidat poznámku do rozvrhu studenta';
...
$string['praxe:beheadmaster'] = 'Umožnit být ředitelem školy';
$string['praxe:confirmlocation'] = 'Potvrdit studentovo přiřazení k nabídce školy';
$string['praxe:confirmownlocation'] = 'Potvrdit studentovo přiřazení k vlastní(ext.teacher) nabídce školy';
$string['praxe:createownlocation'] = 'Vytvořit svou nabídky školy';
$string['praxe:deleteschool'] = 'Smazat školu';
$string['praxe:editanylocation'] = 'Upravit jakoukoliv nabídku školy';
$string['praxe:editanyrecord'] = 'Upravit jakoukoliv studentovu praxi';
$string['praxe:editanyschool'] = 'Upravit jakoukoliv školu';
...
$string['praxe:viewrecordstoanylocation'] = 'Zobrazit všechny praxe';
$string['praxe:viewrecordstoownlocation'] = 'Zobrazit praxe svých nabídek';
$string['praxefieldset'] = 'Specifická nastavení této instance';
$string['praxeintro'] = 'Úvod';
$string['praxename'] = 'Název praxe';
...
$string['schedule-lessontime'] = 'Začátek a konec hodiny';
$string['schedule-lessontime_help'] = 'Začátek hodiny musí začínat dříve dříve než konec hodiny.<br>Rozvrh hodiny je možné přidat nejpozději 4 hodin před začátkem hodiny.';
$string['school'] = 'Škola';
$string['school_added'] = 'Škola byla přidána';
$string['school_detail'] = 'Detail školy';
$string['school_updated'] = 'Informace o škole byly upraveny';
$string['schoolname'] = 'Název školy';
$string['schoolroom'] = 'Učebna';
...
$string['status_confirmed_text'] = 'Výběr školy byl potvrzen.';
...
$string['subject'] = 'Vyučovací předmět';
$string['summerterm'] = 'Letní semestr';
$string['teachers'] = 'Učitelé';
$string['teacher'] = 'Vyučující';
$string['term'] = 'Semestr';
$string['to_create_location_choose_school'] = 'Pro vytvoření nové nabídky vyberte školu.';
$string['todo'] = 'Nesplněno';
$string['typeschool1'] = 'Základní škola';
$string['typeschool2'] = 'Víceleté gymnázium';
$string['typeschool3'] = 'Gymnázium';
$string['typeschool4'] = 'Střední odborná škola';
$string['typeschool5'] = 'Obchodní akademie';
$string['typeschool_other'] = 'Jiný';
$string['unlisted'] = 'Neuveden';
$string['user_assigned_to_school'] = 'Uživatel přiřazen ke škole';
$string['website'] = 'Webové stránky';
$string['winterterm'] = 'Zimní semestr';
$string['year'] = 'Rok';
$string['yearclass'] = 'Ročník';
$string['you_confirmed_location'] = 'Potvrdil(a) jste zařazení studenta k Vám na praxi.';
